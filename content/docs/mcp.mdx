...
| [n8n video workflow](/integrations/n8n) | Manual, self-hosted MCP Client | Tested on 2.38.7 with an exact quote and human approval. [Public template 19591](https://n8n.io/workflows/19591-turn-creative-briefs-into-approved-maxvideoai-generations-with-human-review/) is available; configure OAuth manually. No n8n Cloud or AI Agent support is claimed. |
