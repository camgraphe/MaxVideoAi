...
- Client workspace/billing/library routes: workspace app bootstrap and route-form state hooks, billing session/receipts/top-up quote hooks, and library SWR/mutation hooks.
