...
Mise à jour : 14 septembre 2026. Responsable de décision : Adrien. Statut : seconde passe applicative locale, compositions reconstruites après D58–D59.

**Historique des maquettes avant D57.** Lot visuel : [direction 10 — accueil, Compare et Website Move](review/direction-10/index.html), avec [parti pris, sources et états du mouvement](direction-10.md). Accueil révisé après D53–D55 : références avec vues app desktop/mobile, Connect distinct et intégrations selon la cible de lancement ; diversité et composition D52 conservées. Proposition visuelle à examiner, sans validation automatique ni intégration. Lire [le point de reprise](REPRISE.md) pour la priorité des décisions.
...
**Contexte du 10 septembre, conservé :** les mockups ne convainquent pas encore Adrien. Il souhaite choisir un style à partir de sites réels avant de reprendre les générations. Il apprécie LocalCan, Arrakis et Pryzm et insiste sur leurs animations qui ont du sens. La [lecture des références tech, création et cinéma](references-tech-cinema.md) précise ce qui peut être transposé à MaxVideoAI. La direction 08 reste une exploration ; PAYG, Compare, références, Connect et la continuité SEO/GEO restent centraux. Les vidéos déjà produites par le site seront la matière principale, avec priorité à Camgraph Admin puis aux autres utilisateurs, selon l’autorisation explicite d’Adrien.

**Revue des sources : [références et films 09](review/reference-film-09/index.html).** 100 candidats au premier repérage, puis recherche ciblée chaussures : douze films présélectionnés dont onze Camgraph Admin, captures des trois sites et cadrage du futur système Compare. Les sources du sac ont été retrouvées dans le dossier YouTube : réutiliser uniquement les images et plans, sans Short complet ni présentateur parlant sur le site. La réalisation Website Move avec la montre est écartée : conserver l’idée, mais recréer entièrement le produit et la démonstration. [Provenance, propositions et limites](media-direction-09.md). Ce support sert au choix des scènes et de la direction avant le prochain master anglais ; il ne valide pas une nouvelle homepage.
...
**Périmètre : toutes les familles de pages.** Compare et son scoreboard seront refondus au même titre que l’accueil, les modèles, exemples, outils et tarifs. Dessiner ensemble la synthèse d’accueil et le détail des pages pilotes ; l’existant sert à auditer les informations, pas à imposer son apparence.
...
| [Direction et films 09](media-direction-09.md) · [Revue visuelle](review/reference-film-09/index.html) | Films réels, provenance, images/plans C08 et scènes proposées | Curation livrée ; sélection créative finale ouverte |
...
La [proposition 03](review/home.html) reprend l’accueil et le [brief corrigé](home-replacement-brief.md) ; sa direction visuelle reste à valider. La proposition 02 a été jugée insuffisante. La [revue V1](review/index.html), la [planche de direction](review/direction.html) et l’essai 3D restent des explorations historiques. Leur existence ne valide pas le prototype intégré V3.
