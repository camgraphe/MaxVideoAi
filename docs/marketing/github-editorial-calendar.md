...
> September 16 refresh: the reusable visual paths now contain the current public home page and the public MCP Claude-result section. The older per-unit descriptions of a workspace selector, quote, or matching Library asset are historical planning notes and are superseded by the manifest. Rewrite and reapprove any unit before publication; Claude-specific evidence must not be generalized to other clients.
...
![Current MaxVideoAI home page paired with the public MCP section showing a completed video result in Claude](../../plugins/maxvideoai/assets/demos/readme-proof-hero.webp)
...
![Narrow composite of the current MaxVideoAI home page and public MCP Claude-result section](../../plugins/maxvideoai/assets/demos/model-choice-and-budget.webp)
...
![Current MaxVideoAI home page paired with the public MCP result section for Claude](../../plugins/maxvideoai/assets/demos/brief-to-video-workflow.webp)
...
![Public MaxVideoAI MCP Claude-result section paired with the current MaxVideoAI home page](../../plugins/maxvideoai/assets/demos/library-continuity.webp)
