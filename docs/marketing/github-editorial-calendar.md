...
![MaxVideoAI workspace and Library showing the same public-safe completed video](../../plugins/maxvideoai/assets/demos/library-continuity.webp)

**Proof visual:** `library-continuity.webp`; it proves continuity for the shown completed asset only. **First-party MaxVideoAI fact or workflow:** reference support depends on the selected model and mode; refresh the media selection before preparing. **Source URL:** https://github.com/camgraphe/MaxVideoAi/blob/main/plugins/maxvideoai/examples/reference-to-video.md. **GitHub surface:** `examples/reference-to-video.md` companion. **Website counterpart:** https://maxvideoai.com/docs/mcp. **Outreach class:** secure creator workflow resource. **Canonical backlink:** https://maxvideoai.com/docs/mcp?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Check model support, then choose the Library asset before preparing. **Publication gate:** media privacy, supported-input, and model-mode wording reviewed. **Refresh trigger:** reference capability or permissions change. **Measurement:** reference-guide referrals and safe handoff completion rate.
...
![MaxVideoAI model selector and completed glass-ribbon video](../../plugins/maxvideoai/assets/demos/model-choice-and-budget.webp)

**Proof visual:** `model-choice-and-budget.webp`; it shows a current selection UI and result, not a ranked benchmark. **First-party MaxVideoAI fact or workflow:** live planning is the authority for executable choices and comparable named budgets. **Source URL:** https://github.com/camgraphe/MaxVideoAi/blob/main/frontend/config/model-registry.json. **GitHub surface:** versioned decision-report issue or discussion. **Website counterpart:** https://maxvideoai.com/models. **Outreach class:** benchmark citation or model-comparison resource. **Canonical backlink:** https://maxvideoai.com/models?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Ask for two named routes, including the trade-off each accepts. **Publication gate:** model registry and public page reviewed on publication day. **Refresh trigger:** any model publication, capability, or replacement change. **Measurement:** model-report citations, referrals, and comparison-prompt use.
...
![MaxVideoAI workspace with a current model choice and completed result](../../plugins/maxvideoai/assets/demos/model-choice-and-budget.webp)

**Proof visual:** `model-choice-and-budget.webp`; it does not show a campaign budget or exact quote. **First-party MaxVideoAI fact or workflow:** planning creates comparable named budgets without spending credits; an estimate is not a reservation or debit. **Source URL:** https://github.com/camgraphe/MaxVideoAi/blob/main/plugins/maxvideoai/examples/creator-budget-comparison.md. **GitHub surface:** `examples/price-a-video-project.md`. **Website counterpart:** https://maxvideoai.com/pricing. **Outreach class:** production-planning newsletter. **Canonical backlink:** https://maxvideoai.com/pricing?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Start with the shot list and ask for comparable routes. **Publication gate:** no static money amount; Billing reviews estimate-versus-quote language. **Refresh trigger:** budget tool, model price, or shot assumptions change. **Measurement:** budgeting-example referrals and plan-to-quote progression.

## Week 6: publish only what the release proves

### Unit 11: Plugin release 0.3.0: current proof, platform guides, and public checksums

**Rhythm:** Outcome/proof. **Owner:** Plugin Release Owner. **Human search question:** What changed in MaxVideoAI plugin release 0.3.0? **Agent question:** Locate the reviewed release, installation route, checksum, and compatibility boundary. **Direct answer:** A release is useful when it points to the reviewed package, current product proof, platform guides, and checksums without upgrading a compatibility claim by implication.

![MaxVideoAI release card with a completed workspace video](../../plugins/maxvideoai/assets/social/release-0.3.0.png)

**Proof visual:** `release-0.3.0.png`; it is a release card using MaxVideoAI product proof, not host-validation proof. **First-party MaxVideoAI fact or workflow:** the reviewed package has marketplace metadata and a tagged install route; verify checksums from the release assets. **Source URL:** https://github.com/camgraphe/MaxVideoAi/releases. **GitHub surface:** GitHub Release 0.3.0. **Website counterpart:** https://maxvideoai.com/docs/mcp. **Outreach class:** maintained package registry or release newsletter. **Canonical backlink:** https://maxvideoai.com/docs/mcp?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Read the release notes, then use the command for the reviewed tag. **Publication gate:** source tag, checksum, clean install, support links, and release template completed. **Refresh trigger:** release asset, checksum, or install command changes. **Measurement:** release views, asset downloads, and guide referrals.
...
![Completed result and corresponding saved Library asset](../../plugins/maxvideoai/assets/demos/library-continuity.webp)

**Proof visual:** `library-continuity.webp`; it does not prove a quote, modification, or refund. **First-party MaxVideoAI fact or workflow:** a refunded attempt closes its authorization, while any replacement needs a fresh quote and explicit approval. **Source URL:** https://github.com/camgraphe/MaxVideoAi/blob/main/plugins/maxvideoai/README.md. **GitHub surface:** support discussion linked from release notes. **Website counterpart:** https://maxvideoai.com/pricing. **Outreach class:** creator finance workflow. **Canonical backlink:** https://maxvideoai.com/pricing?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Prepare the revised request, then review its new quote. **Publication gate:** Billing revalidates approval and refund wording. **Refresh trigger:** support pattern or billing-policy change. **Measurement:** support resolution and repeat quote-preparation rate.

## Week 8: keep installation and proof accountable

### Follow-up 15: Release-install evidence refresh

**Rhythm:** Outcome/proof. **Owner:** Plugin Release Owner. **Human search question:** Is the published installation command still the reviewed path? **Agent question:** Revalidate the command, tag, checksum, and docs links after a release. **Direct answer:** Publish an install refresh only when the reviewed tag, package path, checksum, or setup guide changed; otherwise link the existing release.

![MaxVideoAI release card with a current completed-result proof](../../plugins/maxvideoai/assets/social/release-0.3.0.png)

**Proof visual:** `release-0.3.0.png`; it is a release visual, not host validation. **First-party MaxVideoAI fact or workflow:** the release gate pairs the checked-in package path with public checksums and a clean-install review. **Source URL:** https://github.com/camgraphe/MaxVideoAi/releases. **GitHub surface:** release update or pinned discussion. **Website counterpart:** https://maxvideoai.com/docs/mcp. **Outreach class:** technical release newsletter. **Canonical backlink:** https://maxvideoai.com/docs/mcp?utm_source=github&utm_medium=repository&utm_campaign=content-engine. **CTA:** Use the command attached to the reviewed release tag. **Publication gate:** command exercised, checksum published, and support links current. **Refresh trigger:** package/tag/checksum change. **Measurement:** verified install reports and release-to-guide referrals.
