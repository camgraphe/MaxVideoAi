...
| Official MCP Registry | Official MCP Registry | Downstream aggregators | prepared_not_submitted | Legal has not accepted current terms, CC0 metadata dedication, or lack of publisher unpublish | Local schema validation; Legal acceptance; namespace proof; public endpoint; owner-authorized publish action | `https://maxvideoai.com/mcp` | Terms/FAQ change or Legal approval | Legal + MCP Engineering |
