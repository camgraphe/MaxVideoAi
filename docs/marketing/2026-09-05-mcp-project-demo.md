...
Textes, chemins, canoniques, hreflang, JSON-LD, liens et affichages EN/FR/ES vérifiés. Build de production réussi (860 pages), 77 tests ciblés accueil/MCP réussis. TypeScript, lint, SEO, exposition publique et traductions passent. Avance, retour arrière, arrêt et absence de débordement vérifiés dans le navigateur aux tailles ordinateur et mobile ; détails et limites dans `design-qa.md`. L’aperçu local utilise le build de production. Aucun déploiement effectué.
