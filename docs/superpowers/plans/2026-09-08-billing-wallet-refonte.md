...
- [x] **Step 1: Write failing request-scope and architecture tests**
...
- [x] **Step 3: Implement the scoped data lifecycle**
...
- Create: `frontend/app/(core)/billing/_components/billing-layout.module.css`
- Create: `frontend/app/(core)/billing/_components/billing-topup.module.css`
- Create: `frontend/app/(core)/billing/_components/billing-receipts.module.css`
...
- [x] **Step 1: Write failing presentation and localization tests**
...
- [x] **Step 3: Implement the new composition**
...
- Modify: `frontend/app/(core)/billing/_components/billing-layout.module.css`
- Modify: `frontend/app/(core)/billing/_components/billing-receipts.module.css`
- Modify: `frontend/app/(core)/billing/_lib/billing-copy.ts`
- Modify: `frontend/messages/en.json`
- Modify: `frontend/messages/fr.json`
- Modify: `frontend/messages/es.json`
...
- [x] **Step 1: Write failing reconciliation and ledger contract tests**
...
- [x] **Step 3: Implement reconciliation and ledger UI**
...
- [x] **Step 4: Run Billing and Stripe-facing tests**
...
- [x] **Step 1: Start the isolated preview on port 3037**

Use the repository's verified disposable/local preview setup without reading or printing secrets. Confirm port 3037 is isolated from the existing process on 3026, then start the frontend with public-only local placeholders and an explicitly labelled Billing fixture. Do not follow the payment CTA into a real payment.

- [x] **Step 2: Inspect desktop and mobile, light and dark**
...
- [x] **Step 3: Inspect keyboard and reduced motion**
...
- [x] **Step 4: Run full relevant gates**
