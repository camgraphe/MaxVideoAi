...
- [x] **Step 1: Add failing tests for the current `/company` false positive**
...
- [x] **Step 2: Run the tests and SEO guard to prove the baseline failure**
...
- [x] **Step 3: Narrowly classify the analytics file as a non-link owner**
...
- [x] **Step 4: Record the live P0 contract**
...
- [x] **Step 5: Re-run the baseline suite**
...
- [x] **Step 6: Commit the isolated baseline/source-contract change**
...
- [x] **Step 1: Write lifecycle validation tests first**
...
- [x] **Step 2: Run the registry tests and confirm they fail**
...
- [x] **Step 3: Implement schema version 2 and invariants**
...
- [x] **Step 4: Project lifecycle into runtime and engine entries**
...
- [x] **Step 5: Migrate existing models without changing their existing publication intent**
...
- [x] **Step 6: Regenerate and verify the canonical projections**
...
- [x] **Step 1: Add contract tests for every model/mode/endpoint**
...
- [x] **Step 2: Run the tests and confirm missing-module failures**
...
- [x] **Step 3: Implement raw engine modules**
...
- [x] **Step 4: Verify module and architecture contracts**
...
- [x] **Step 1: Add full-object request tests before implementation**
...
- [x] **Step 2: Run new tests and relevant regressions**
...
- [x] **Step 3: Add one provider-field resolver**
...
- [x] **Step 4: Wire validation and workspace mode availability**
...
- [x] **Step 5: Verify provider, API, and workspace behavior**
...
- [x] **Step 1: Add failing pricing fact and parity cases**
...
- [x] **Step 2: Run the pricing tests and prove the missing dimensions**
...
- [x] **Step 3: Extend the factual pricing shape, not page copy**
...
- [x] **Step 4: Enter the exact Task 1 live rates and review fixtures**
...
- [x] **Step 5: Run pricing authority and audit gates**
...
- [x] **Step 1: Add failing identity, family, successor, and brand tests**
...
- [x] **Step 2: Run the tests and confirm missing registry identities**
...
- [x] **Step 3: Add the seven current registry entries as hidden**
...
- [x] **Step 4: Add family and brand ownership**
...
- [x] **Step 5: Generate and verify all projections**
...
- [x] **Step 1: Add failing lifecycle-aware MCP tests**
...
- [x] **Step 2: Run MCP tests and confirm missing behavior**
...
- [x] **Step 3: Project lifecycle and exact capabilities from canonical sources**
...
- [x] **Step 4: Keep budgeting and confirmation on the canonical path**
...
- [x] **Step 5: Run MCP and pricing parity gates**
...
- [x] **Step 1: Add failing template/content/SEO contract tests**
...
- [x] **Step 2: Run the focused model-page tests**
...
- [x] **Step 3: Implement page templates from runtime/pricing facts**
...
- [x] **Step 4: Author and review EN/FR/ES content**
...
- [x] **Step 5: Verify content, locale, and link contracts**
...
- [x] **Step 1: Add failing discovery and quote-source tests**
...
- [x] **Step 2: Run pricing/pay-as-you-go tests**
...
- [x] **Step 3: Update pricing hub ownership**
...
- [x] **Step 4: Update the pay-as-you-go acquisition surface**
...
- [x] **Step 5: Verify pricing parity and localized routes**
...
- [x] **Step 1: Add failing curated-discovery tests**
...
- [x] **Step 3: Update models and family discovery data**
...
- [x] **Step 4: Gate homepage and example navigation on accepted assets**
...
- [x] **Step 5: Verify discovery, locale, and no-orphan assumptions**
...
- [x] **Step 1: Add failing SEO graph and classification tests**
...
- [x] **Step 3: Update contextual linking and best-for ownership**
...
- [x] **Step 4: Update machine discovery and monitoring**
...
- [x] **Step 5: Verify canonical, hreflang, sitemap, and LLMS behavior**
...
- [x] **Step 4: Generate one attempt at a time under exact confirmation**
...
- [x] **Step 1: Add failing score completeness and presentation tests**
...
- [x] **Step 2: Run score/comparison tests**
...
- [x] **Step 3: Review the fourteen accepted outputs with the repository rubric**
...
- [x] **Step 4: Author exact specs and eight comparison documents**
...
- [x] **Step 5: Verify scores, locale content, indexation, and no-showdown policy**
...
- [x] **Step 1: Add one failing atomic readiness test**
...
- [x] **Step 2: Run readiness test and fix only missing prerequisites**
...
- [x] **Step 3: Flip registry and family publication atomically**
...
- [x] **Step 4: Regenerate projections and verify the complete public graph**
...
- [x] **Step 5: Commit the atomic publication**
...
- [x] **Step 1: Run focused architecture and contract suites**
...
- [x] **Step 2: Run repository-wide release gates**
...
- [x] **Step 3: Smoke-test public and authenticated surfaces locally**
...
- [x] **Step 4: Capture launch monitoring baselines**
...
- [x] **Step 5: Define the 28-day redirect review gate**
