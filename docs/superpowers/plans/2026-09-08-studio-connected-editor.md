...
- QA authentifiée séparée : résolveur médias HTTP `7cbafa1db` approuvé ; transport MCP réel et audit local `4d40827cd` passe 1/1, revue en cours. Aucun de ces tests ne prétend déjà prouver le montage enregistré ou sa lecture privée.
