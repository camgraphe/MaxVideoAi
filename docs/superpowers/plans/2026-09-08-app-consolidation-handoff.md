...
Les corrections 78cc5c59b puis b91b44942 sont acceptées en revue indépendante :26 tests réels/ciblés, verrous terminaux communs, résolution Restore mesurée et délégation du cron existant, y compris lignes masquées. Observation Fal annulable5s, vidéo traitée avant finishing, rotation après délai ; finalisation une fois réclamée entièrement attendue. Pas de plafond absolu de stockage promis, ni nouvelle planification ou resoumission. Les profils restent désactivés tant que la qualification fournisseur n’est pas faite. Smart Reframe, Subtitles, Clean Audio, Remove Object et Extend Clip restent des sujets ultérieurs.
...
Ces défauts ont été reproduits puis corrigés en `c453e604b` avec un propriétaire de requêtes commun, le masquage au rendu et la réconciliation différée jusqu’à l’auth confirmée. Les 42 tests ciblés, le lint Billing et le typecheck réel frontend passent. Rapport `5ecfaecec`. La relecture indépendante de c453e604b est PASS. Le correctif de lectures Billing 9a4a42af0 est également accepté : GET currency/receipts sans bootstrap, erreurs DB en 503 et comparaison contrôlée locale (médianes18,24→7,91ms et18,33→8,18ms). Ce ne sont pas des mesures distantes/CWV. QA visuelle mobile390/320 et desktop1440, clair/sombre, déjà observée ; contrôle final après stabilisation encore requis.
...
2. Billing/corrections P0 Toolbox/latence des lectures Billing sont acceptés en relecture. Poursuivre la validation de composition. Traiter chaque incrément avec ses dépendances, sans fusion globale des anciens worktrees.
