...
test('MaxVideoAI editor owns graph, node, generation, and capability contracts', () => {
  ...
  assert.match(workspaceSource, /exportTimelineVideo/, 'workspace should wire the primary export video action from the export controller');
  assert.match(workspaceSource, /exportTimelineRender/, 'workspace should wire the topbar export action to timeline render handoff');
  ...
  assert.match(workspaceSource, /videoViewerProps=\{\{[\s\S]*playheadSec: previewPlayheadSec/, 'workspace should pass the shared playhead into the montage viewer props');
  ...
  assert.match(workspaceSource, /timelineClipInspectorProps=\{\{[\s\S]*selectedItem: selectedTimelineItem/, 'viewer mode inspector should edit the selected timeline item');
  assert.match(workspaceSource, /timelineClipInspectorProps=\{\{[\s\S]*onPatchItem: handlePatchTimelineItem/, 'viewer mode inspector should patch timeline clip edit properties');
  ...
  assert.match(timelineStyleSource, /\.timelineToolButton/, 'timeline editing tools should be styled in focused timeline CSS');
  assert.match(timelineStyleSource, /\.timelineToolGroup/, 'timeline editing tool group should be styled in focused timeline CSS');
