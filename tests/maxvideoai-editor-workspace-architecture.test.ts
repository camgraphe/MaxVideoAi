...
test('MaxVideoAI editor owns graph, node, generation, and capability contracts', () => {
  ...
  assert.match(shotInputDockSource, /aria-label=\{connectorDescription/, 'generate block input rows should expose remaining capacity to assistive tech and browser smoke tests');
