...
test('examples route components own nav and JSON-LD rendering', () => {
  ...
  assert.match(routeSectionsSource, /ltx-2-5-fast-pricing/, 'LTX examples pricing should target the current generation');
  assert.match(routeSectionsSource, /kling-o3-pro-pricing/, 'Kling examples pricing should retain its existing pricing anchor');
