...
const representative = {
  en: {
    ...
    heroIntro: 'Generate AI videos from text, images, audio, or video with pay-as-you-go credits. Compare LTX 2.5, Wan 3, Grok Imagine, FLUX.3, Seedance, Kling, Google Veo and other models, review the price before each generation, and only spend credits on completed renders.',
  ...
  fr: {
    ...
    heroIntro: 'Générez des vidéos IA à partir de texte, d’images, d’audio ou de vidéo avec des crédits prépayés. Comparez LTX 2.5, Wan 3, Grok Imagine, FLUX.3, Seedance, Kling, Google Veo et d’autres modèles, puis validez le devis avant chaque génération.',
    ...
    pricingHref: '/fr/tarifs#video-pricing',
  ...
  es: {
    ...
    heroIntro: 'Genera videos con IA a partir de texto, imágenes, audio o video con créditos de pago por uso. Compara LTX 2.5, Wan 3, Grok Imagine, FLUX.3, Seedance, Kling, Google Veo y otros modelos, y aprueba la cotización antes de cada generación.',
    ...
    pricingHref: '/es/precios#video-pricing',
