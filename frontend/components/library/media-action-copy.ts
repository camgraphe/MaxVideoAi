export function mediaActionCopy(locale: string) {
  if (locale.startsWith('fr')) return { title: 'Continuer avec ce média', close: 'Fermer', preview: 'Aperçu', download: 'Télécharger l’original', video: 'Créer une vidéo', image: 'Créer une image', animate: 'Animer cette image', reference: 'Choisir le rôle de référence', actions: 'Actions', back: 'Retour', next: 'Le rôle et la compatibilité seront vérifiés dans le créateur.', error: 'Impossible de préparer ce média. Réessayez.' };
  if (locale.startsWith('es')) return { title: 'Continuar con este medio', close: 'Cerrar', preview: 'Vista previa', download: 'Descargar original', video: 'Crear un vídeo', image: 'Crear una imagen', animate: 'Animar esta imagen', reference: 'Elegir el rol de referencia', actions: 'Acciones', back: 'Volver', next: 'El creador comprobará el rol y la compatibilidad.', error: 'No se pudo preparar este medio. Inténtalo de nuevo.' };
  return { title: 'Continue with this media', close: 'Close', preview: 'Preview', download: 'Download original', video: 'Create a video', image: 'Create an image', animate: 'Animate this image', reference: 'Choose reference role', actions: 'Actions', back: 'Back', next: 'The creator will check the reference role and compatibility.', error: 'Unable to prepare this media. Please try again.' };
}
