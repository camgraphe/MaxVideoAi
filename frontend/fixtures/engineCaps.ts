...
'fal-ai/luma-dream-machine/ray-2': {
  ...
  audioToggle: false,
  notes: 'Supports 5s/9s clips with 540p/720p/1080p resolution. Loop option available.',
},
'fal-ai/luma-dream-machine/ray-2/image-to-video': {
  ...
  aspectRatio: ['16:9', '9:16', '4:3', '3:4', '21:9', '9:21'],
  audioToggle: false,
  acceptsImageFormats: ['png', 'jpeg', 'jpg', 'webp'],
  maxUploadMB: 50,
  notes: 'Requires a reference image URL or upload. Loop option available.',
},
