export const DEFAULT_ANGLE_COPY = {
  ...
  "addSourceBody": "Drop, paste, upload, or choose from Media.",
  "upload": "Upload",
  "uploading": "Uploading...",
  ...
  "libraryError": "Failed to load Media images",
  ...
  "alreadyInLibrary": "Already in Media",
  "download": "Download",
  ...
  "libraryImageName": "Media image",
  "missingSource": "Upload a source image first.",
  "generationFailed": "Generation failed",
  "angleOutputLabel": "Angle Output",
  "librarySaveFailed": "Media save failed",
  "authGate": {
    "title": "Create an account to generate angles",
    "body": "Guests can explore the tool and browse public examples, but generation, uploads, and Media actions require an account.",
