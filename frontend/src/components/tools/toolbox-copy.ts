...
type Copy = typeof en;
const fr: Copy = { ...en, title: 'Outils', subtitle: 'De petits gestes. Une autre image.', quick: 'Outils rapides', workshops: 'Ateliers', workshopHint: 'Donnez de la suite à vos idées.', all: 'Tous', image: 'Image', video: 'Vidéo', audio: 'Audio', open: 'Ouvrir l’outil', workshopOpen: 'Entrer dans l’atelier', illustration: 'Illustration', noAudio: 'Pas encore d’outil de finition audio.', audioHint: 'Créez musique, voix et sons dans l’espace Audio.', audioOpen: 'Ouvrir Audio', source: 'Source', import: 'Importer', library: 'Bibliothèque', url: 'Coller une URL', original: 'Original', result: 'Résultat', preserved: 'Votre original reste intact.', advanced: 'Options', implementation: 'Méthode de traitement', empty: 'Place à votre média.', emptyHint: 'Importez un fichier ou choisissez dans votre bibliothèque.', reuse: 'Réutiliser ce résultat', back: 'Outils', settings: 'Réglages', retryPrice: 'Actualiser le prix', upscale: 'Agrandir', removeBackground: 'Détourer', priceLoading: 'Calcul du prix…', size: 'Taille', format: 'Format', background: 'Fond', keepAudio: 'Garder le son', done: 'Terminé', compare: 'Comparer', signIn: 'Se connecter', processing: 'Traitement du média…', processingHint: 'En attente du résultat final. Gardez cette page ouverte.', tools: {
...
const es: Copy = { ...en, title: 'Herramientas', subtitle: 'Pequeños cambios. Otra imagen.', quick: 'Herramientas rápidas', workshops: 'Talleres', workshopHint: 'Lleva tus ideas más lejos.', all: 'Todos', image: 'Imagen', video: 'Vídeo', audio: 'Audio', open: 'Abrir herramienta', workshopOpen: 'Entrar al taller', illustration: 'Ilustración', noAudio: 'Aún no hay herramientas de acabado de audio.', audioHint: 'Crea música, voces y sonidos en Audio.', audioOpen: 'Abrir Audio', source: 'Origen', import: 'Importar', library: 'Biblioteca', url: 'Pegar URL', original: 'Original', result: 'Resultado', preserved: 'Tu original queda intacto.', advanced: 'Opciones', implementation: 'Método de procesamiento', empty: 'Espacio para tus medios.', emptyHint: 'Importa un archivo o elige uno de tu biblioteca.', reuse: 'Reutilizar este resultado', back: 'Herramientas', settings: 'Ajustes', retryPrice: 'Actualizar precio', upscale: 'Ampliar', removeBackground: 'Quitar fondo', priceLoading: 'Calculando precio…', size: 'Tamaño', format: 'Formato', background: 'Fondo', keepAudio: 'Mantener audio', done: 'Listo', compare: 'Comparar', signIn: 'Iniciar sesión', processing: 'Procesando el archivo…', processingHint: 'Esperando el resultado final. Mantén esta página abierta.', tools: {
