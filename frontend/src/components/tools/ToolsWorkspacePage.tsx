...
const DEFAULT_TOOLS_COPY = {
  ...
  "backgroundRemovalBody": "Remove video backgrounds with Bria VRMBG 3.0, export transparent WebM clips, and test paid realtime webcam previews.",
  "backgroundRemovalBadge": "Studio + live",
  "open": "Open Tool"
} as const;
