// Frozen v1 compatibility document. Keep the rendered bytes and the SHA-256
// contract unchanged; publish future UI changes under a new resource URI.
...
export function buildLegacyReferenceUploadAppHtml(): string {
  return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
