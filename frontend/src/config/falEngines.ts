...
const BYTEPLUS_SEEDANCE_2_FAST_MODEL_ID = 'dreamina-seedance-2-0-fast-260128';
const BYTEPLUS_SEEDANCE_2_FAST_CAPS_ID = 'byteplus/dreamina-seedance-2.0-fast/text-to-video';
