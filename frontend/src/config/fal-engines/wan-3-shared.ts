...
export function createWan3Engine(options: {
  ...
  return {
    ...
    pricing: { unit: 'USD/s', base: options.perSecondUsd['1080p'], byResolution: options.perSecondUsd, currency: 'USD', notes: 'Provider cost per input and generated output video second, selected by output resolution.' },
