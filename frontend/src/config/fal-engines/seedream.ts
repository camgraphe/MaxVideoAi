    ...
    optional: [
      {
        ...
        step: 1,
        default: 1,
        description: 'Seedream 5.0 Lite returns one image per standard request.',
      },
      {
        id: 'aspect_ratio',
        type: 'enum',
      ...
      },
      {
        ...
        description: 'Add up to 14 source images for Seedream edit mode.',
        modes: ['i2i'],
        requiredInModes: ['i2i'],
        minCount: 1,
        maxCount: 14,
    ...
    modes: [
      ...
      },
      {
        ...
        ui: {
          ...
          maxUploadMB: 10,
          notes: 'Edit with up to 14 source images for more controlled visual references.',
        },
      },
    ],
