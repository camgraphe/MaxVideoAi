...
const en: PricingHubCopy = {
  ...
  quote: {
    ...
    durationsOnly: (seconds) => `${seconds.join('/')}s only`,
    resolutionOnly: (resolution) => `${resolution} only`,
    resolutionUnavailable: (resolution) => `${resolution} unavailable`,
  ...
  video: {
    ...
    highlights: {
      bestDraft: 'Best-value current-gen 5s 720p',
...
const fr: PricingHubCopy = {
  ...
  quote: {
    ...
    durationsOnly: (seconds) => `${seconds.map((second) => formatSeconds('fr', second)).join('/')} uniquement`,
    resolutionOnly: (resolution) => `${resolution} uniquement`,
    resolutionUnavailable: (resolution) => `${resolution} indisponible`,
  ...
  video: {
    ...
    highlights: {
      bestDraft: 'Meilleur prix actuel 5 s 720p',
...
const es: PricingHubCopy = {
  ...
  quote: {
    ...
    durationsOnly: (seconds) => `solo ${seconds.map((second) => formatSeconds('es', second)).join('/')}`,
    resolutionOnly: (resolution) => `solo ${resolution}`,
    resolutionUnavailable: (resolution) => `${resolution} no disponible`,
  ...
  video: {
    ...
    highlights: {
      bestDraft: 'Mejor valor actual 5 s 720p',
