...
function englishCopy(client: McpClientId): IntegrationPageCopy {
  ...
  return {
    ...
    hero: {
      ...
      unavailable: 'Direct production access will open after the final launch checks. The workflow and setup path are ready to review.',
    ...
    references: {
      ...
      gatedBody: 'Plan the references in the conversation, then use the MaxVideoAI website for the final upload until production connection access opens.',
    },
    troubleshooting: {
      eyebrow: 'HELP',
...
function frenchCopy(client: McpClientId): IntegrationPageCopy {
  ...
  return {
    ...
    hero: {
      ...
      unavailable: 'L’accès direct en production ouvrira après les derniers contrôles de lancement. Le parcours et la configuration sont prêts à être consultés.',
    ...
    references: {
      ...
      gatedBody: 'Préparez les références dans la conversation, puis utilisez le site MaxVideoAI pour l’envoi final avant l’ouverture de la connexion production.',
    },
    troubleshooting: {
      eyebrow: 'AIDE',
...
function spanishCopy(client: McpClientId): IntegrationPageCopy {
  ...
  return {
    ...
    hero: {
      ...
      unavailable: 'El acceso directo de producción se abrirá tras las últimas comprobaciones. El flujo y la configuración ya se pueden consultar.',
    ...
    references: {
      ...
      gatedBody: 'Planifica las referencias en la conversación y usa el sitio MaxVideoAI para la carga final hasta que se abra la conexión de producción.',
    },
    troubleshooting: {
      eyebrow: 'AYUDA',
