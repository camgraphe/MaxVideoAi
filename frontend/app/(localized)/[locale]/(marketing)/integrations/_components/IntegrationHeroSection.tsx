        ...
        <div className="max-w-[650px]">
          <div className="flex h-14 w-14 items-center justify-center rounded-[12px] border border-hairline bg-white shadow-card dark:border-white/[0.16] dark:bg-neutral-900">
            {mark ? (
              ...
              <span data-integration-monogram aria-hidden="true" className="text-sm font-bold uppercase tracking-tight text-text-primary dark:text-white">
                {copy.clientLabel.slice(0, 2)}
              </span>
            )}
          </div>
