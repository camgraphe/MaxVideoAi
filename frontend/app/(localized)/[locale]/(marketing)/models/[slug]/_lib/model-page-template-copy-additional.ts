...
const LUMA_RAY_32_COPY: LocalizedTemplateCopy = {
  en: {
    ...
    referenceWorkflows: [
      ...
      { title: 'Optional references', body: 'Use reference images only when the public route accepts them and each reference has a clear role.' },
  ...
  fr: {
    hero: {
      ...
      title: 'Luma Ray 3.2',
      subtitle: 'Mouvement cinématique Ray 3.2 pour plans de 5 s ou 10 s, avec routage Luma direct et relais fal si nécessaire.',
      subtitleHighlights: ['Mouvement cinématique Ray 3.2', 'plans de 5 s ou 10 s', 'routage Luma direct et relais fal'],
      paragraph:
        'Utilisez Ray 3.2 pour la génération Luma actuelle en texte vers vidéo et image vers vidéo : clips courts, sortie 540p à 1080p, boucle optionnelle sur les cas publics pris en charge et réglages publics prudents.',
    ...
    media: {
      ...
      description: 'Route Luma actuelle de génération cinématique',
      renderLabel: 'Voir le rendu',
      badges: ['5 s/10 s', '540p-1080p', 'T2V + I2V'],
      altContext: 'exemple video cinematique Luma Ray 3.2',
    },
    features: [
      { title: 'Vidéo Luma actuelle', body: 'Utilisez Ray 3.2 pour les routes publiques 5 s et 10 s.', tone: 'quality' },
      { title: 'Texte ou image source', body: 'Partez d’un prompt ou animez une image validée comme première frame.', tone: 'reference' },
      { title: '540p à 1080p', body: 'Brouillonnez plus bas, puis contrôlez les clips retenus en 720p ou 1080p.', tone: 'quality' },
      { title: 'Pensé pour les boucles', body: 'Activez la boucle sur les cas publics compatibles quand la consigne demande un mouvement court continu.', tone: 'continuity' },
      { title: 'Réglages publics prudents', body: 'La page reste alignée sur les options publiques déjà couvertes par les prix de référence.', tone: 'duration' },
      { title: 'Paiement à l’usage', body: 'Les prix utilisent l’affichage MaxVideoAI de référence avant génération.', tone: 'price' },
    ],
    decisionCards: [
      {
        title: 'Ray 3.2 ou Ray 2 ?',
        body: 'Prenez Ray 3.2 pour la route publique actuelle en 5 s/10 s. Prenez Ray 2 si les retouches vidéo ou le recadrage comptent davantage.',
        cta: { label: 'Voir Ray 2', href: modelsHref('fr', 'luma-ray-2') },
      },
      {
        title: 'Prompt seul ou image source ?',
        body: 'Utilisez le prompt seul pour un nouveau plan. Ajoutez une image quand produit, cadrage, personnage ou composition doivent ancrer le départ.',
        cta: { label: 'Ouvrir le Prompt Lab', href: '#prompting' },
      },
      {
        title: 'Quand choisir 10 s ?',
        body: 'Utilisez 10 s pour une révélation plus lente ou un mouvement complet. Gardez 5 s pour boucles, tests et plans produit courts.',
        cta: { label: 'Vérifier le prix', href: pricingHref('fr', 'luma-ray-3-2-pricing') },
      },
    ],
    referenceWorkflows: [
      { title: 'Prompt texte', body: 'Décrivez sujet, action, caméra, lumière, style et cible de sortie dans une consigne de plan compacte.' },
      { title: 'Image de départ', body: 'Chargez une première frame propre quand identité, géométrie produit ou composition doivent rester ancrées.' },
      { title: 'Références optionnelles', body: 'Ajoutez des images de référence seulement si la route publique les accepte et si chacune a un rôle clair.' },
      { title: 'Boucle continue', body: 'Gardez un mouvement simple, cyclique et limité si le clip doit boucler.' },
      { title: 'Vérification finale 1080p', body: 'Explorez en 540p ou 720p, puis contrôlez les rendus retenus en 1080p.' },
    ],
    pricingCopy: {
      ...
      footnote: 'Les exemples publics utilisent les réglages publiés 5 s/10 s et 540p/720p/1080p, pas des options avancées non publiées.',
      ctaLabel: 'Voir tous les tarifs',
      maxDurationNote: 'Jusqu’à 1080p',
    },
    meta: {
      ...
      description:
        'Explorez Luma Ray 3.2 : prix, texte vers vidéo et image vers vidéo en 5 s ou 10 s, sortie 540p à 1080p, prompts et exemples.',
    },
  },
  es: {
    hero: {
      ...
      title: 'Luma Ray 3.2',
      subtitle: 'Movimiento cinematográfico Ray 3.2 para tomas de 5 s o 10 s, con ruta directa de Luma y respaldo fal cuando haga falta.',
      subtitleHighlights: ['Movimiento cinematográfico Ray 3.2', 'tomas de 5 s o 10 s', 'ruta directa de Luma y respaldo fal'],
      paragraph:
        'Usa Ray 3.2 para la ruta Luma actual de texto a video e imagen a video cuando necesitas clips cortos, salida 540p a 1080p, bucle opcional en casos públicos compatibles y ajustes públicos prudentes.',
    ...
    media: {
      ...
      description: 'Ruta Luma actual de generación cinematográfica',
      renderLabel: 'Ver render',
      badges: ['5 s/10 s', '540p-1080p', 'T2V + I2V'],
      altContext: 'ejemplo de video cinematografico con Luma Ray 3.2',
    },
    features: [
      { title: 'Video Luma actual', body: 'Usa Ray 3.2 para rutas públicas de generación de 5 s y 10 s.', tone: 'quality' },
      { title: 'Texto o imagen inicial', body: 'Empieza desde prompt o anima una imagen aprobada como cuadro de apertura.', tone: 'reference' },
      { title: '540p a 1080p', body: 'Borrador en resolución menor y revisa clips elegidos en 720p o 1080p.', tone: 'quality' },
      { title: 'Preparado para bucles', body: 'Usa bucle en casos públicos compatibles cuando conviene una prueba corta y continua.', tone: 'continuity' },
      { title: 'Ajustes públicos prudentes', body: 'La página mantiene opciones públicas alineadas con precios de referencia.', tone: 'duration' },
      { title: 'Pago por uso', body: 'Los precios usan el cálculo de referencia MaxVideoAI antes de generar.', tone: 'price' },
    ],
    decisionCards: [
      {
        title: '¿Ray 3.2 o Ray 2?',
        body: 'Usa Ray 3.2 para la ruta pública actual de 5 s/10 s. Usa Ray 2 cuando importan más las ediciones de video o el reencuadre.',
        cta: { label: 'Ver Ray 2', href: modelsHref('es', 'luma-ray-2') },
      },
      {
        title: '¿Solo prompt o imagen inicial?',
        body: 'Usa solo prompt para una toma nueva. Agrega imagen cuando producto, encuadre, personaje o composición deben anclar el inicio.',
        cta: { label: 'Abrir Prompt Lab', href: '#prompting' },
      },
      {
        title: 'Cuándo usar 10 s',
        body: 'Usa 10 s para una revelación más lenta o movimiento completo. Mantén 5 s para bucles, pruebas y tomas de producto breves.',
        cta: { label: 'Revisar precio', href: pricingHref('es', 'luma-ray-3-2-pricing') },
      },
    ],
    referenceWorkflows: [
      { title: 'Prompt de texto', body: 'Describe sujeto, acción, cámara, luz, estilo y salida deseada en una consigna compacta.' },
      { title: 'Imagen inicial', body: 'Sube un cuadro inicial limpio cuando identidad, geometría de producto o composición deben quedar ancladas.' },
      { title: 'Referencias opcionales', body: 'Agrega imágenes de referencia solo si la ruta pública las acepta y cada una tiene un rol claro.' },
      { title: 'Bucle continuo', body: 'Mantén movimiento simple, cíclico y limitado cuando el clip deba repetirse.' },
      { title: 'Revisión final 1080p', body: 'Explora en 540p o 720p y revisa renders elegidos en 1080p.' },
    ],
    pricingCopy: {
      ...
      footnote: 'Los ejemplos públicos usan ajustes publicados de 5 s/10 s y 540p/720p/1080p, no opciones avanzadas no publicadas.',
      ctaLabel: 'Ver precios completos',
      maxDurationNote: 'Hasta 1080p',
    },
    meta: {
