...
const SEEDANCE_20_COPY: Record<AppLocale, CopyWithoutPricingScenarios> = {
  en: {
    hero: {
...
const SEEDANCE_20_FAST_COPY: Record<AppLocale, CopyWithoutPricingScenarios> = {
  en: {
    hero: {
...
const LTX_23_FAST_COPY: Record<AppLocale, CopyWithoutPricingScenarios> = {
  en: {
    hero: {
...
const COPY_BY_MODEL_SLUG: Record<string, Record<AppLocale, CopyWithoutPricingScenarios>> = {
...
export function buildModelDecisionData({
  ...
  const copyByLocale = COPY_BY_MODEL_SLUG[engine.modelSlug];
  ...
  return {
    ...
    pricing: {
      ...
      cta: { label: copy.pricingCopy.ctaLabel, href: pricingHref(locale, `${engine.modelSlug}-pricing`) },
      scenarios,
    },
  };
}
