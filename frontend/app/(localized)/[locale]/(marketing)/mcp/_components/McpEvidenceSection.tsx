...
export function McpEvidenceSection({
  ...
  return (
    <aside
      aria-labelledby="mcp-generation-evidence-title"
      className="rounded-[16px] border border-hairline bg-surface p-3 text-text-primary shadow-card dark:border-white/[0.16] dark:bg-white/[0.04] dark:text-white"
      data-mcp-evidence="generation-proof"
    >
      <div className="mb-3 flex flex-wrap items-end justify-between gap-2 px-1">
        <div>
          ...
          <h2 id="mcp-generation-evidence-title" className="mt-1 text-lg font-semibold text-text-primary dark:text-white">{copy.title}</h2>
