  ...
  trust: {
    ...
    compatibility: {
      ...
      statuses: {
        ...
        chatgptWeb: 'Full MCP is documented for eligible Business and Enterprise/Edu workspaces on ChatGPT web, but a direct MaxVideoAI installation and output-rendering check has not yet been recorded.',
  ...
  return {
    ...
    trust: {
      ...
      compatibility: { ...EN.trust.compatibility, title: 'Parcours de connexion testés', body: 'Le serveur est partagé entre assistants, mais chaque hôte est vérifié séparément.', checkpointLabel: 'Revue hébergée', statuses: {
        ...
        chatgptWeb: 'Le MCP complet est documenté pour les espaces Business et Enterprise/Edu éligibles sur ChatGPT web, mais aucune installation MaxVideoAI ni aucun rendu de résultat n’y a encore été enregistré.',
...
function spanishCopy(): McpPageCopy {
  return {
    ...
    trust: { ...EN.trust,
      ...
      compatibility: { ...EN.trust.compatibility, title: 'Rutas de conexión probadas', body: 'El servidor se comparte entre asistentes, pero cada cliente se comprueba por separado.', checkpointLabel: 'Revisión alojada', statuses: { claudeDesktop: 'Claude Desktop 1.37937.1 completó OAuth, catálogo, presupuesto, precio exacto, medios, recuperación, carga y recarga.', claudeCode: 'La configuración del conector compartido está lista, pero todavía no se ha registrado una comprobación directa de Claude Code en producción.', chatgptWeb: 'MCP completo está documentado para espacios Business y Enterprise/Edu elegibles en ChatGPT web, pero todavía no se ha registrado una instalación directa de MaxVideoAI ni el renderizado del resultado.', codexCli: 'Codex CLI 0.150.0-alpha.8 completó en producción la instalación, OAuth, cuenta, catálogo, recomendaciones, presupuestos, precio exacto, generación de pago, recuperación y contrato del reproductor integrado.' } },
