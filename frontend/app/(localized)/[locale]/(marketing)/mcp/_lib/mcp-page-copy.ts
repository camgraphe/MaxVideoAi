...
function spanishCopy(): McpPageCopy {
  return {
    ...
    trust: { ...EN.trust,
      ...
      availability: { title: 'Cuánto cuesta', liveBody: 'El plugin, asesoramiento y presupuestos son gratuitos. La generación usa tus créditos MaxVideoAI de pago por uso sin suscripción adicional.', gatedBody: 'El asesoramiento y los presupuestos son gratuitos. La generación usa tus créditos MaxVideoAI de pago por uso sin suscripción adicional.' },
