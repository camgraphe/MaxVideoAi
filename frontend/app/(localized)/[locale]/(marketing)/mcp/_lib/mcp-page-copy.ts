...
const EN: McpPageCopy = {
  ...
  ecosystem: {
    overviewLabel: 'Explore the MCP ecosystem',
    overviewIntro: 'Claude, ChatGPT and Codex are the live primary choices. Explore validation previews now and see which development and enterprise platforms are being prepared next.',
    overview: [
...
function frenchCopy(): McpPageCopy {
  return {
    ...
    ecosystem: {
      overviewLabel: 'Explorez l’écosystème MCP',
      overviewIntro: 'Claude, ChatGPT et Codex restent les choix principaux déjà en ligne. Explorez les aperçus en validation et découvrez les plateformes de développement et d’entreprise préparées ensuite.',
      overview: [
...
function spanishCopy(): McpPageCopy {
  return {
    ...
    ecosystem: {
      overviewLabel: 'Explora el ecosistema MCP',
      overviewIntro: 'Claude, ChatGPT y Codex siguen siendo las opciones principales ya publicadas. Explora las vistas previas en validación y descubre las plataformas de desarrollo y empresa que se preparan después.',
      overview: [
