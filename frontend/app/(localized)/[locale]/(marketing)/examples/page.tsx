...
> = {
  ...
  'ltx-2-3-fast': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'ltx-2-3': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/text-to-video': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/image-to-video': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/audio-to-video': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/extend-video': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/retake-video': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/text-to-video/fast': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
  'fal-ai/ltx-2.3/image-to-video/fast': { id: 'ltx-2-3', label: 'LTX 2.3 Pro', brandId: 'lightricks' },
