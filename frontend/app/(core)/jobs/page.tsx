...
import {
  JobsPageShell,
  type GroupedJobAction,
  type JobsPageSection,
  type JobsSectionKey,
} from './_components/JobsPageShell';
import { useJobsCopy } from './_hooks/useJobsCopy';
import {
...
export default function JobsPage() {
  ...
  return (
    <JobsPageShell
      copy={copy}
      hasCuratedVideo={hasCuratedVideo}
      sections={sections}
      collapsedSections={collapsedSections}
      onToggleSection={toggleSection}
      engineLookupById={engineLookupById}
      onGroupOpen={handleGroupOpen}
      onGroupAction={handleGroupAction}
      allowRemove={allowRemove}
      savingImageGroupIds={savingImageGroupIds}
