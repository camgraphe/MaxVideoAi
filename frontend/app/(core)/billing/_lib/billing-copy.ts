export const DEFAULT_BILLING_COPY = {
  ...
  wallet: {
    ...
    stepReviewHint: "Use your card’s currency to help avoid bank conversion fees.",
    ...
    checkoutCta: "Pay by card",
    checkoutNote: "Secure payment by Stripe. Credits are added after confirmation; your receipt is saved here.",
    firstTopupAmexNotice: "American Express is unavailable in card checkout for your first top-up.",
    ...
    expressUnavailable: "Instant payment is unavailable. You can pay by card below.",
    expressError: "Unable to open instant payment. Please use the card option below.",
    expressClosed: "Payment window closed. Try again or pay by card below.",
