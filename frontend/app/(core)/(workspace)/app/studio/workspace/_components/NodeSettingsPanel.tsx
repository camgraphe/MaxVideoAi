  ...
  return (
    <>
      ...
      <div className={styles.infoGrid}>
        ...
        <strong>{
          output?.sourceMetadata?.measurementStatus === 'measured' && output.sourceMetadata.durationSec
    ...
    <aside ref={panelRef} tabIndex={-1} className={styles.settingsPanel} aria-label={copy.nodeSettingsAria}>
      ...
      <div className={styles.settingsBody}>
        ...
        {selectedNode.data.kind === 'shot' ? (
          <ShotNodeInspector copy={copy} controlCopy={controlCopy} node={selectedNode} edges={edges} capabilities={capabilities} onPatchShot={onPatchShot} onGenerateShot={onGenerateShot} />
        ) : null}
        {selectedNode.data.kind === 'chat' ? (
          <ChatNodeInspector copy={copy} controlCopy={controlCopy} node={selectedNode} onPatchNodeData={onPatchNodeData} onRunChat={onRunChat} />
        ) : null}
