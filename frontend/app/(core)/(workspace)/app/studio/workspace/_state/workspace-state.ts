...
export const MIN_TIMELINE_AUDIO_TRACKS = 2;
...
export type CanvasHistorySnapshot = CanvasGraphHistorySnapshot & {
  guideState: WorkspaceCanvasGuideState;
};
...
export function createWorkspaceSequenceRecord(params: {
  ...
  const timelineItems = normalizeWorkspaceTimelineIdentities(
    normalizeWorkspaceTimelineItemsSourceMetadata(params.timelineItems)
  );
