...
export type StudioGuideCopyKey =
...
export type StudioControlCopy = {
  labels: {
    ...
    characterOutputMode: string;
    characterConsistencyMode: string;
    characterQualityMode: string;
    characterFormatMode: string;
    characterReferenceStrength: string;
    characterTraits: string;
    angleRotation: string;
    angleTilt: string;
    angleZoom: string;
    angleSafeMode: string;
    angleBestAngles: string;
    upscaleMode: string;
    ...
    chatMessage: string;
    storyboardTargetModel: string;
    storyboardFrameCount: string;
    storyboardDurationSec: string;
    storyboardOrientation: string;
    storyboardTier: string;
  };
  options: {
    on: string;
    off: string;
    ...
    landscape: string;
    portrait: string;
    characterPortraitReference: string;
    characterSheet: string;
    characterExploratory: string;
    characterBalanced: string;
    characterStrict: string;
    characterLoose: string;
    characterStrong: string;
    characterStandard: string;
    characterPro: string;
    realismPhotoreal: string;
    realismCinematic: string;
    realismStylized: string;
    realismAnimated: string;
    moodEpic: string;
    moodTense: string;
    moodIntimate: string;
    moodDark: string;
    moodDreamy: string;
    moodSciFi: string;
    moodDocumentary: string;
    intensitySubtle: string;
    intensityStandard: string;
    ...
    profileWarm: string;
    profileBright: string;
    profileDeep: string;
    deliveryNatural: string;
    deliveryCinematic: string;
    deliveryTrailer: string;
    deliveryIntimate: string;
    languageAuto: string;
  ...
  specialized: {
    ...
    labels: {
      ...
      preserveFaceDetails: string;
      avoid3dRenderLook: string;
      notes: string;
    ...
    options: {
      ...
      hairTiedBack: string;
      outfitCasual: string;
      outfitBusiness: string;
      outfitStreetwear: string;
      outfitFormal: string;
      outfitLuxury: string;
      outfitSciFi: string;
      outfitFantasy: string;
      outfitTactical: string;
      accessoryGlasses: string;
      accessorySunglasses: string;
      accessoryEarrings: string;
      accessoryNecklace: string;
      accessoryHat: string;
      accessoryHeadscarf: string;
    };
  };
  policy: {
    startImageDisablesReference: string;
    referenceDisablesStartImage: string;
    unsupportedInput: string;
    connectRequiredSingle: string;
    connectRequiredPlural: string;
...
export type StudioCopy = {
  projects: {
    ...
    starterDisclaimer: string;
    startTemplateAria: string;
    canvasPreviewLabel: string;
    resultPreviewLabel: string;
    starterNames: {
      productAd: string;
      storyboardToVideo: string;
      cinematicTrailer: string;
    };
    blankProject: string;
    blankProjectDescription: string;
    allProjects: string;
...
export const DEFAULT_STUDIO_COPY: StudioCopy = {
  projects: {
    ...
    starterTitle: 'Studio Editor',
    starterSubtitle: 'Build video workflows on an infinite canvas.',
    starterDisclaimer: 'Starters only prepare the canvas. Nothing is generated until you choose to run a block.',
    startTemplateAria: 'Start {name}',
    canvasPreviewLabel: 'Canvas',
    resultPreviewLabel: 'Result',
    starterNames: {
      productAd: 'Product Ad',
      storyboardToVideo: 'Storyboard to Video',
      cinematicTrailer: 'Cinematic Trailer',
    },
    blankProject: 'Blank project',
    blankProjectDescription: 'Start with a prompt and an empty video output.',
    ...
    montage: {
      ...
      projectTitle: 'Project title', library: 'Eligible videos from Media', loading: 'Loading videos…',
      ...
      errorLibrary: 'Media videos could not be loaded.', retryLibrary: 'Retry Media videos',
    },
  },
  topbar: {
  ...
  canvas: {
    ...
    guide: {
      controls: {
        menu: 'Guide options',
        listLabel: 'Canvas workflow guide',
        show: 'Show guide',
        hide: 'Hide guide',
        deleteOne: 'Delete this explanation',
        deleteAll: 'Delete all explanations',
        deleteAllConfirm: 'Delete all guide explanations? You can restore them with Canvas undo or Reset guide.',
        reset: 'Reset guide',
      ...
      steps: {
        ...
        'guided-product-ad:prompt': { title: 'Describe the shot', body: 'Specify movement, lighting, framing, and atmosphere.', ariaLabel: 'Step 2: Describe the shot' },
        'guided-product-ad:generate': { title: 'Check and generate', body: 'Confirm the model, duration, format, and estimate before generating.', ariaLabel: 'Step 3: Check and generate' },
        'guided-product-ad:output': { title: 'Review the result', body: 'Check the clip, retry if needed, then send it to the timeline.', ariaLabel: 'Step 4: Review the result' },
        'guided-product-ad:timeline': { title: 'Continue editing', body: 'Canvas creates media; Viewer and the timeline handle trim, framing, and audio.', ariaLabel: 'Step 5: Continue editing' },
        'guided-storyboard-to-video:reference': { title: 'Choose the storyboard', body: 'Replace these panels with the ordered frames that define your sequence.', ariaLabel: 'Step 1: Choose the storyboard' },
        'guided-storyboard-to-video:prompt': { title: 'Direct motion and continuity', body: 'Describe camera movement, screen direction, pacing, and transitions between panels.', ariaLabel: 'Step 2: Direct motion and continuity' },
        'guided-storyboard-to-video:generate': { title: 'Check the storyboard render', body: 'Confirm the compatible model, settings, and estimate before generating.', ariaLabel: 'Step 3: Check the storyboard render' },
        'guided-storyboard-to-video:output': { title: 'Review the sequence', body: 'Check panel order and continuity, retry if needed, then send the result to the timeline.', ariaLabel: 'Step 4: Review the sequence' },
        'guided-storyboard-to-video:timeline': { title: 'Refine the edit', body: 'Use Viewer and the timeline to trim the sequence, adjust framing, and mix audio.', ariaLabel: 'Step 5: Refine the edit' },
        'guided-cinematic-scene:reference': { title: 'Set the visual anchor', body: 'Replace this mood plate with the image that defines the scene and first frame.', ariaLabel: 'Step 1: Set the visual anchor' },
        'guided-cinematic-scene:prompt': { title: 'Direct the camera and scene', body: 'Describe the camera intent, subject reveal, atmosphere, and final beat.', ariaLabel: 'Step 2: Direct the camera and scene' },
        'guided-cinematic-scene:generate': { title: 'Check the cinematic render', body: 'Confirm the model, format, motion settings, and estimate before generating.', ariaLabel: 'Step 3: Check the cinematic render' },
        'guided-cinematic-scene:output': { title: 'Review the shot', body: 'Check the camera move and visual continuity, retry if needed, then send it to the timeline.', ariaLabel: 'Step 4: Review the shot' },
        'guided-cinematic-scene:timeline': { title: 'Finish in Viewer', body: 'Use Viewer and the timeline to refine timing, framing, transitions, and sound.', ariaLabel: 'Step 5: Finish in Viewer' },
      },
    },
    controls: {
      labels: {
        ...
        characterOutputMode: 'Output',
        characterConsistencyMode: 'Consistency',
        characterQualityMode: 'Quality',
        characterFormatMode: 'Format',
        characterReferenceStrength: 'Reference',
        characterTraits: 'Style',
        angleRotation: 'Rotation',
        angleTilt: 'Tilt',
        angleZoom: 'Zoom',
        angleSafeMode: 'Safe mode',
        angleBestAngles: 'Best angles',
        upscaleMode: 'Mode',
        upscaleFactor: 'Factor',
        outputFormat: 'Format',
        audioMood: 'Mood',
        audioIntensity: 'Intensity',
        audioMusicEnabled: 'Music bed',
        voiceGender: 'Voice',
        ...
        chatMessage: 'Message',
        storyboardTargetModel: 'Target model',
        storyboardFrameCount: 'Frames',
        storyboardDurationSec: 'Duration',
      ...
      options: {
        ...
        landscape: 'Landscape',
        portrait: 'Portrait',
        characterPortraitReference: 'Portrait reference',
        characterSheet: 'Character sheet',
        characterExploratory: 'Exploratory',
        characterBalanced: 'Balanced',
        characterStrict: 'Strict',
        characterLoose: 'Loose',
        characterStrong: 'Strong',
        characterStandard: 'Standard',
        characterPro: 'Pro',
        realismPhotoreal: 'Photoreal',
        realismCinematic: 'Cinematic',
        realismStylized: 'Stylized',
        realismAnimated: 'Animated',
        moodEpic: 'Epic',
        moodTense: 'Tense',
        moodIntimate: 'Intimate',
        moodDark: 'Dark',
        moodDreamy: 'Dreamy',
        moodSciFi: 'Sci-fi',
        moodDocumentary: 'Documentary',
        ...
        profileWarm: 'Warm',
        profileBright: 'Bright',
        profileDeep: 'Deep',
        deliveryNatural: 'Natural',
        deliveryCinematic: 'Cinematic',
        deliveryTrailer: 'Trailer',
        deliveryIntimate: 'Intimate',
        languageAuto: 'Auto',
      ...
      specialized: {
        ...
        labels: {
          ...
          preserveFaceDetails: 'Preserve face details',
          avoid3dRenderLook: 'Avoid 3D render look',
          notes: 'Notes',
        ...
        options: {
          ...
          hairMedium: 'Medium',
          hairLong: 'Long',
          hairVeryLong: 'Very long',
          hairStraight: 'Straight',
          hairWavyBob: 'Wavy bob',
          hairCurly: 'Curly',
          hairPonytail: 'Ponytail',
          hairBraids: 'Braids',
          hairBuzzCut: 'Buzz cut',
          hairAfro: 'Afro',
          hairTiedBack: 'Tied back',
          outfitCasual: 'Casual',
          outfitBusiness: 'Business',
          outfitStreetwear: 'Streetwear',
          outfitFormal: 'Formal',
          outfitLuxury: 'Luxury',
          outfitSciFi: 'Sci-fi',
          outfitFantasy: 'Fantasy',
          outfitTactical: 'Tactical',
          accessoryGlasses: 'Glasses',
          accessorySunglasses: 'Sunglasses',
          accessoryEarrings: 'Earrings',
          accessoryNecklace: 'Necklace',
          accessoryHat: 'Hat',
          accessoryHeadscarf: 'Headscarf',
        },
      },
      policy: {
        startImageDisablesReference: 'Start image mode disables reference images.',
        referenceDisablesStartImage: 'Reference mode disables start image.',
        unsupportedInput: 'Selected model does not support {input} input.',
        connectRequiredSingle: 'Connect required {inputs} input.',
        connectRequiredPlural: 'Connect required {inputs} inputs.',
        incompatibleModel: 'Selected model is not compatible with this block.',
      },
    },
    toolbar: {
    ...
    nodes: {
      ...
      modifyImageDescription: 'Edit or restyle an existing image source.',
      modifyImageTitle: 'Modify image',
      modifyImageSubtitle: 'Image edit workflow.',
      ...
      storyboardGenerationSubtitle: 'Storyboard boards and continuity frames.',
      character: 'Character Builder',
      characterDescription: 'Create a reusable character reference from identity notes or images.',
      characterGenerationTitle: 'Character Builder',
      characterGenerationSubtitle: 'Consistent character reference tool.',
      angle: 'Angle',
      angleDescription: 'Generate a stronger camera angle from an image reference.',
      angleGenerationTitle: 'Angle generation',
      angleGenerationSubtitle: 'Camera-angle tool for stronger first frames.',
      upscale: 'Upscale',
      ...
      soundDesignDescription: 'Create cinematic sound design from a video reference.',
      soundDesignGenerationTitle: 'Sound design',
      soundDesignGenerationSubtitle: 'Cinematic ambience and scene audio.',
      soundDesignVoice: 'Sound design + voice',
      soundDesignVoiceDescription: 'Create scene audio with synced voice direction.',
      soundDesignVoiceGenerationTitle: 'Sound design + voice',
      soundDesignVoiceGenerationSubtitle: 'Cinematic audio with voice direction.',
      freeText: 'Free text',
      ...
      chatMode: 'Mode',
      llmBlockMode: 'LLM block',
      chatbotMode: 'Chatbot',
      chatbotName: 'Chatbot name',
      chatbotNamePlaceholder: 'Name this chatbot...',
      chatbotDefaultName: 'Studio assistant',
      chatInputPlaceholder: 'Ask the chatbot...',
      emptyChat: 'Start a conversation from this block.',
      userLabel: 'You',
      ...
      running: 'Running',
      send: 'Send',
      chatSimulate: 'Simulate',
      chatLiveUnavailable: 'Live Chat unavailable: pricing authorization is not supported yet.',
      chatSimulationResponse: 'Simulation — local echo, no model was called:',
      copyLastAnswer: 'Copy last answer',
      reuseLastMessage: 'Reuse last message',
      ...
      anglePickerTitle: '3D Angle Picker',
      anglePickerHint: 'Hold and drag to change camera angle',
      anglePickerChooseAngle: 'Choose angle',
      anglePickerConnectReference: 'Connect reference',
      anglePickerRotation: 'Rotation',
      anglePickerTilt: 'Tilt',
      anglePickerZoom: 'Zoom',
      anglePickerBestAngles: '4 best angles',
      ...
      enginePickerSearch: 'Search engines...',
      enginePickerFamilies: 'Families',
      enginePickerModels: 'Models',
      enginePickerNoResults: 'No compatible engine matches this search.',
      enginePickerUnavailable: 'Unavailable',
      enginePickerCurrentInputsIncompatible: 'Not compatible with the current connected inputs.',
      enginePickerPaused: 'This engine is temporarily paused.',
      enginePickerWaitlist: 'This engine is currently available by waitlist only.',
      enginePickerFamilyCount: '{count} families',
      enginePickerModelCount: '{count} models',
      enginePickerOpen: 'Choose an engine',
      aspect: 'Aspect',
      resolution: 'Resolution',
      fps: 'FPS',
  ...
  timeline: {
    ...
    inspector: {
      ...
      fitHeightToSequence: 'Fit clip height to sequence',
      fitHeightUnavailable: 'Source height unavailable',
  ...
  viewer: {
    ...
    projectMedia: {
      ...
      gridView: 'Grid view',
      mediaKindFilters: 'Project media type filters',
  ...
  assetLibrary: {
    retryLibrary: 'Retry',
    library: 'Choose from Media',
    selectAsset: 'Select {type}',
    selectForNode: 'Select {type} for {node}',
    closeLibrary: 'Close Media',
    closeProjectMediaLibrary: 'Close Project media',
    upload: 'Upload',
    uploading: 'Uploading...',
    ...
    noProjectMedia: 'No media in Project media yet.',
    invalidProjectMediaUpload: 'Upload image, video, or audio media for the project.',
    searchAssets: 'Search assets',
    searchPlaceholder: 'Search assets...',
    searchLoadedItemsHint: 'Search applies to loaded assets. Use Load more to fetch more results.',
    sourceFilters: 'Media asset filters',
    mediaKindFilters: 'Media type filters',
    mediaKindAll: 'All media',
    mediaKindImage: 'Image',
    mediaKindVideo: 'Video',
    mediaKindAudio: 'Audio',
    showingDevAssets: 'Showing dev assets while Media is empty.',
    loadingLibrary: 'Loading Media...',
    loadMore: 'Load more',
    loading: 'Loading',
    loadingMore: 'Loading more...',
    signInToAccessLibrary: 'Sign in to access Media.',
    unableToLoadLibrary: 'Unable to load Media.',
    assetSingular: 'asset',
    assetPlural: 'assets',
    emptyLibrary: 'No matching media in Media yet.',
    emptySearch: 'No assets match this search.',
    useAsset: 'Use {name}',
    selectAssetForImport: 'Select {name}',
    deselectAssetForImport: 'Deselect {name}',
