...
const copy = {
  en: {
    ...
    retired: 'The saved model is unavailable. Its draft is kept in Previous settings.',
  ...
  fr: {
    ...
    retired: 'Le modèle enregistré est indisponible. Son brouillon reste dans Réglages précédents.',
    memory:
