...
export const DEFAULT_COPY: ImageWorkspaceCopy = {
  ...
  composer: {
    ...
    referenceNote:
      'Drag & drop, paste, upload from your device, or choose from Media. These references are required for Edit mode.',
    referenceButton: 'Choose from Media',
    ...
    referenceSlotHint: 'Drop image, click to upload, paste, or choose from Media.',
  ...
  messages: {
    ...
    removedFromLibrary: 'Removed from Media.',
  },
  general: {
    uploading: 'Uploading…',
  ...
  library: {
    button: 'Choose from Media',
    empty: 'No assets saved yet. Upload images from the composer or the Media page.',
    ...
    modal: {
      ...
      emptyUploads: 'No uploaded images yet. Upload images from the composer or the Media page.',
