...
export const VIDEO_SEO_EDITORIAL_ENTRIES = [
  {
  "id": "e2ef7bdf-e78c-4aca-94b4-d2ba74036dac",
  "seoStatus": "approved",
  "seoTitle": "Wan 3 Alpine Runner Multi-Shot Video with Native Audio",
  "metaDescription": "Watch a 10-second Wan 3 alpine runner sequence with three cinematic shots, stable character identity, mountain motion and native audio.",
  "h1": "Wan 3 alpine runner multi-shot video with native audio",
  "videoObjectName": "Wan 3 alpine runner multi-shot mountain sequence",
  "shortDescription": "This Wan 3 text-to-video example follows one yellow-jacketed runner from a close portrait through a trail sprint to a wide summit finish, preserving identity across three connected shots with native audio.",
  "targetKeyword": "Wan 3 multi-shot video example",
  "intent": "audio-enabled",
  "modelSlug": "wan-3",
  "examplesSlug": "wan",
  "canonicalSlug": "wan-3-alpine-runner-multishot"
},
  {
  "id": "feccb90c-11ed-48ef-a96b-b7c80e5fe1c5",
  "seoStatus": "approved",
  "seoTitle": "Wan 3 Prime Chef Multi-Shot Video with Native Audio",
  "metaDescription": "Watch a 10-second Wan 3 Prime chef sequence with connected kitchen shots, stable identity, premium food styling and native audio.",
  "h1": "Wan 3 Prime chef multi-shot video with native audio",
  "videoObjectName": "Wan 3 Prime chef plating multi-shot kitchen sequence",
  "shortDescription": "This Wan 3 Prime example moves from a wide professional kitchen to plating and a close presentation, keeping the chef and copper-lit workspace consistent across connected shots with native audio.",
  "targetKeyword": "Wan 3 Prime multi-shot video",
  "intent": "audio-enabled",
  "modelSlug": "wan-3-prime",
  "examplesSlug": "wan",
  "canonicalSlug": "wan-3-prime-chef-multishot"
},
  {
  "id": "bd943cbc-c500-49ff-baff-d7e1f03fb2dc",
  "seoStatus": "approved",
  "seoTitle": "LTX 2.5 Fast Street Rhythm Video with Native Audio",
  "metaDescription": "Watch an LTX 2.5 Fast street performance with energetic crowd motion, a rapid camera push-in, expressive faces and native audio.",
  "h1": "LTX 2.5 Fast street rhythm video with native audio",
  "videoObjectName": "LTX 2.5 Fast street percussion and crowd sequence",
  "shortDescription": "This LTX 2.5 Fast text-to-video example turns a busy public-square performance into a lively forward-moving shot, balancing percussion, crowd motion and a clear human close-up with native audio.",
  "targetKeyword": "LTX 2.5 Fast video example",
  "intent": "audio-enabled",
  "modelSlug": "ltx-2-5-fast",
  "examplesSlug": "ltx",
  "canonicalSlug": "ltx-2-5-fast-street-rhythm"
},
  {
  "id": "5d47efd3-c75c-42c0-91fc-e0e1d8b50357",
  "seoStatus": "approved",
  "seoTitle": "LTX 2.5 Pro Lantern Release Video with Native Audio",
  "metaDescription": "Watch an LTX 2.5 Pro lakeside lantern release with stable characters, controlled hand motion, warm light and native audio.",
  "h1": "LTX 2.5 Pro lantern release video with native audio",
  "videoObjectName": "LTX 2.5 Pro lakeside paper lantern release sequence",
  "shortDescription": "This LTX 2.5 Pro text-to-video example follows a couple as they hold and release a glowing paper lantern beside a lake, preserving faces, hand placement and the emotional blue-hour atmosphere with native audio.",
  "targetKeyword": "LTX 2.5 Pro video example",
  "intent": "audio-enabled",
  "modelSlug": "ltx-2-5-pro",
  "examplesSlug": "ltx",
  "canonicalSlug": "ltx-2-5-pro-lantern-release"
},
  {
  "id": "4467d48a-8d6a-490c-96ba-09468aea313e",
  "seoStatus": "approved",
  "seoTitle": "Grok Imagine Video 1.5 Lunar Barista Video with Audio",
  "metaDescription": "Watch a Grok Imagine Video 1.5 lunar barista pour with a consistent astronaut, playful zero-gravity liquid and native audio.",
  "h1": "Grok Imagine Video 1.5 lunar barista video with audio",
  "videoObjectName": "Grok Imagine Video 1.5 lunar astronaut barista scene",
  "shortDescription": "This Grok Imagine Video 1.5 text-to-video example stages an astronaut as a lunar barista, keeping the character and coffee station coherent while zero-gravity droplets create a playful visual payoff with native audio.",
  "targetKeyword": "Grok Imagine Video 1.5 example",
  "intent": "audio-enabled",
  "modelSlug": "grok-imagine-video-1-5",
  "examplesSlug": "grok",
  "canonicalSlug": "grok-1-5-lunar-barista"
},
  {
  "id": "abd1a29b-7de8-4bb5-bc24-1c670d3b0a88",
  "seoStatus": "approved",
  "seoTitle": "FLUX 3 Season-Shifting Train Station Video Example",
  "metaDescription": "Watch a FLUX 3 train station transform from spring to autumn and winter while preserving its traveler, symmetry and architecture.",
  "h1": "FLUX 3 season-shifting train station video example",
  "videoObjectName": "FLUX 3 season-shifting glass train station sequence",
  "shortDescription": "This FLUX 3 text-to-video example transforms a monumental glass-roof station through three seasons while the central traveler, camera axis and architectural geometry remain visually consistent.",
  "targetKeyword": "FLUX 3 video example",
  "intent": "camera-motion",
  "modelSlug": "flux-3",
  "examplesSlug": "flux",
  "canonicalSlug": "flux-3-season-shifting-station"
},
  {
  "id": "34605e6e-0a3a-4b23-ac71-9985b486bd01",
  "seoStatus": "approved",
  "seoTitle": "FLUX 3 Draft Neon Cyclist Tunnel Video Example",
  "metaDescription": "Watch a FLUX 3 Draft cyclist race through a concrete tunnel with colored light trails, coherent geometry and native audio.",
  "h1": "FLUX 3 Draft neon cyclist tunnel video example",
  "videoObjectName": "FLUX 3 Draft neon cyclist tunnel speed sequence",
  "shortDescription": "This FLUX 3 Draft text-to-video example uses a low rear camera to follow a cyclist through a concrete tunnel, preserving bicycle geometry while colored light trails amplify speed and direction.",
  "targetKeyword": "FLUX 3 Draft video example",
  "intent": "camera-motion",
  "modelSlug": "flux-3-draft",
  "examplesSlug": "flux",
  "canonicalSlug": "flux-3-draft-neon-cyclist"
},
  {
