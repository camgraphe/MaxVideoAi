...
export const VIDEO_SEO_WATCHLIST: readonly SeoWatchVideoConfig[] = [
  ...
  "engineLabel": "Wan 3",
  "sourceType": "models",
  "sourcePath": "/models/wan-3",
  "sourceLabel": "Model page · Wan 3",
  "seoTitle": "Wan 3 Alpine Runner Multi-Shot Video with Native Audio",
  "intro": "A yellow-jacketed trail runner moves from close portrait to mountain sprint and summit reveal across three connected shots.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 274,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  "watchPageEligible": true,
  "videoPrimaryIntent": "multi-shot",
  "exampleFamily": "wan",
  "styleTags": [
    "cinematic",
    "outdoor",
  ...
  "engineSlug": "wan-3-prime",
  "engineFamily": "wan",
  "engineLabel": "Wan 3 Prime",
  "sourceType": "models",
  "sourcePath": "/models/wan-3-prime",
  "sourceLabel": "Model page · Wan 3 Prime",
  "seoTitle": "Wan 3 Prime Chef Multi-Shot Video with Native Audio",
  "intro": "A chef crosses a copper-lit kitchen, plates a dish and presents it through a polished connected-shot sequence.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 273,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  ...
  "engineSlug": "ltx-2-5-fast",
  "engineFamily": "ltx",
  "engineLabel": "LTX 2.5 Fast",
  "sourceType": "models",
  "sourcePath": "/models/ltx-2-5-fast",
  "sourceLabel": "Model page · LTX 2.5 Fast",
  "seoTitle": "LTX 2.5 Fast Street Rhythm Video with Native Audio",
  "intro": "A public-square percussion performance drives through a moving crowd into a bright, expressive close portrait.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 272,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  ...
  "engineSlug": "ltx-2-5-pro",
  "engineFamily": "ltx",
  "engineLabel": "LTX 2.5 Pro",
  "sourceType": "models",
  "sourcePath": "/models/ltx-2-5-pro",
  "sourceLabel": "Model page · LTX 2.5 Pro",
  "seoTitle": "LTX 2.5 Pro Lantern Release Video with Native Audio",
  "intro": "A couple releases a glowing paper lantern beside a lake, moving from an intimate portrait to a clean airborne payoff.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 271,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  ...
  "engineSlug": "grok-imagine-video-1-5",
  "engineFamily": "grok",
  "engineLabel": "Grok Imagine Video 1.5",
  "sourceType": "models",
  "sourcePath": "/models/grok-imagine-video-1-5",
  "sourceLabel": "Model page · Grok Imagine Video 1.5",
  "seoTitle": "Grok Imagine Video 1.5 Lunar Barista Video with Audio",
  "intro": "An astronaut works as a lunar barista while coffee droplets arc through low gravity in front of an Earth-view window.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 270,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  "watchPageEligible": true,
  "videoPrimaryIntent": "prompt-example",
  "exampleFamily": "grok",
  "styleTags": [
    "cinematic",
    "science-fiction",
  ...
  "engineLabel": "FLUX 3",
  "sourceType": "models",
  "sourcePath": "/models/flux-3",
  "sourceLabel": "Model page · FLUX 3",
  "seoTitle": "FLUX 3 Season-Shifting Train Station Video Example",
  "intro": "A centered traveler crosses a monumental station while the environment shifts from spring through autumn into winter.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 269,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
  "watchPageEligible": true,
  "videoPrimaryIntent": "camera-motion",
  "exampleFamily": "flux",
  "styleTags": [
    "cinematic",
    "architectural",
  ...
  "engineSlug": "flux-3-draft",
  "engineFamily": "flux",
  "engineLabel": "FLUX 3 Draft",
  "sourceType": "models",
  "sourcePath": "/models/flux-3-draft",
  "sourceLabel": "Model page · FLUX 3 Draft",
  "seoTitle": "FLUX 3 Draft Neon Cyclist Tunnel Video Example",
  "intro": "A cyclist accelerates through a concrete tunnel as colored light trails converge toward a bright exit.",
  "reasonForSelection": "Accepted P0 launch render with durable model and family playlist attachment.",
  "priority": 268,
  "publishedAt": "2026-09-02T15:44:24.524Z",
  "modifiedAt": "2026-09-02T15:44:24.524Z",
...
},
  {
    ...
    intro:
      'A mountain lookout races from a storm tower to build a red flare corridor for stranded hikers across four connected shots with native stereo sound.',
    reasonForSelection: 'Accepted character-led hero render on the MiniMax H3 model page.',
    priority: 261,
    publishedAt: '2026-08-08T18:18:57.303Z',
    watchPageEligible: true,
    videoPrimaryIntent: 'audio-enabled',
    exampleFamily: 'minimax',
    styleTags: ['cinematic', 'character', 'rescue'],
  ...
  },
  {
    ...
    reasonForSelection: 'Accepted lighthouse render paired with the prompt lab on the MiniMax H3 model page.',
    priority: 260,
