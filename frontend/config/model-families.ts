...
const MODEL_FAMILY_SOURCES = [
  ...
  },
  {
    id: 'wan',
    label: 'Wan',
    navLabel: 'Wan 3 Prime',
    brandId: 'wan',
    defaultModelId: 'wan-3-prime',
    modelOrderIds: ['wan-3-prime', 'wan-3', 'wan-2-6', 'wan-2-5'],
    routeAliases: ['wan-3-prime', 'wan-3', 'wan-2-6', 'wan-2-5'],
    aliases: ['wan-3.0', 'wan-30', 'wan30', 'wan-25', 'wan25', 'wan-26', 'wan26'],
    prefixes: ['wan', 'wan/', 'alibaba/wan-3.0'],
    examplesPage: {
      stage: 'indexed',
      showInNav: true,
    },
  ...
  },
  {
    id: 'ltx',
    label: 'LTX',
    navLabel: 'LTX 2.5 Pro',
    brandId: 'lightricks',
    defaultModelId: 'ltx-2-5-pro',
    modelOrderIds: ['ltx-2-5-pro', 'ltx-2-5-fast', 'ltx-2-3', 'ltx-2-3-fast', 'ltx-2', 'ltx-2-fast'],
    routeAliases: ['ltx-2-5-pro', 'ltx-2-5-fast', 'ltx-2-3', 'ltx-2-3-pro', 'ltx-2-3-fast', 'ltx-2', 'ltx-2-fast'],
    aliases: ['ltx-25', 'ltx25', 'ltx-25-fast', 'ltx25-fast', 'ltx-23', 'ltx23', 'ltx-23-fast', 'ltx23-fast'],
    prefixes: ['ltx', 'fal-ai/ltx', 'lightricks/ltx-2.5'],
    examplesPage: {
      stage: 'indexed',
      showInNav: true,
    },
  },
  {
    ...
    aliases: ['grok-video', 'grok-imagine', 'grok-1-5', 'grok-1.5'],
    prefixes: ['grok', 'xai/grok-imagine-video'],
    examplesPage: {
      stage: 'indexed',
      showInNav: true,
    },
  },
  {
    ...
    routeAliases: ['flux-3', 'flux-3-draft'],
    aliases: ['flux-video', 'flux-3-video', 'flux-video-draft'],
    prefixes: ['flux-3', 'blackforestlabs/flux-3'],
    examplesPage: {
      stage: 'indexed',
      showInNav: true,
    },
