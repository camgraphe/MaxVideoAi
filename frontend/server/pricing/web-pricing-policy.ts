...
import { LIVE_PRICING_POLICY_REVISION, PRICING_POLICY_HEADER, WEB_PRICING_REFRESH_MESSAGE } from '@/lib/membership-policy';
...
export function requireCurrentWebPricingPolicy(
  ...
  const message = WEB_PRICING_REFRESH_MESSAGE;
