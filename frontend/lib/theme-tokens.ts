...
export const THEME_TOKEN_DEFS: ThemeTokenDefinition[] = [
  ...
  { key: 'engine-xai-bg', label: 'xAI bg', group: 'engines', input: 'color', advanced: true },
  { key: 'engine-xai-ink', label: 'xAI ink', group: 'engines', input: 'color', advanced: true },
  { key: 'engine-black-forest-labs-bg', label: 'Black Forest Labs bg', group: 'engines', input: 'color', advanced: true },
  { key: 'engine-black-forest-labs-ink', label: 'Black Forest Labs ink', group: 'engines', input: 'color', advanced: true },
