...
function buildLaunchPacket(options, paths) {
  ...
  return [
    ...
    '4. Verify every localized `decision` and `prompting` block has the exact `modelSlug` and locale-correct hrefs before enabling the model page.',
    '5. Confirm Prompt Lab uses each requested locale directly, with no English prompting fallback.',
