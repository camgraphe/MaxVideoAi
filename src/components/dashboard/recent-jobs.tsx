          ...
          <ul className="space-y-4">
            {jobs.slice(0, 4).map((job) => {
              ...
              return (
                <li
                  key={job.id}
                  className="flex flex-col gap-3 rounded-xl border border-black/10 bg-white/90 p-4 transition hover:border-primary/40 dark:border-white/10 dark:bg-black/40 md:flex-row md:items-center md:justify-between"
                >
                  <div>
